# Generated by Django 2.2.19 on 2021-04-09 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datacriacao', models.DateTimeField(auto_now_add=True)),
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disciplinafk', to='gestaoacademicaapp.Disciplina', verbose_name='Disciplinas')),
